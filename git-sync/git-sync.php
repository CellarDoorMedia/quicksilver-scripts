...
// Thanks to Matt Paladino at Pantheon for the basis for this script and all his help!
...
// You can edit these as appropriate
...
$git_user = $gitSecrets['username'];
$remote_git_repo = $gitSecrets['repository'];
$main_branch = $gitSecrets['mainBranch'];
...
$github_remote="$git_user:$git_token@$remote_git_repo";
...
if ($local == $remote) {
  ...
  exec("git push $github_remote $main_branch");
  print "\n Pushed to Github.";
} else {
